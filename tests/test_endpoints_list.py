...
def test_endpoints__list(fx_app, fx_auth_admin, page, per_page, include_metadata, endpoint):
...
@pytest.mark.parametrize('endpoint', [ROLES_URL, USERS_URL])
def test_endpoints__list__error_400(fx_app, fx_auth_admin, page, per_page, include_metadata, endpoint):
