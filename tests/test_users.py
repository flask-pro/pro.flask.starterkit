...
def test_users__bad_id(fx_app):
    print('\n--> test_users__bad_id')

    r_get = fx_app.get('/v1/users/1234567890')
    assert r_get.status_code == 404

    updated_user = {'id': 1234567890, 'username': 'updated_test_user'}
    r_update = fx_app.put('/v1/users/1234567890', json=updated_user)
    assert r_update.status_code == 404

    r_delete = fx_app.delete('/v1/users/1234567890')
